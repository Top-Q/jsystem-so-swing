...
/**
 * this class is used to locate graphical component by a given name\ with a given class and name
 * 
 * @author Nizan Freedman
 *
 */
public class ComponentChooserHelper implements ComponentChooser {
	 ...
	 */
	public ComponentChooserHelper(String name){
		this.name = name;
	}
	 ...
	 */
	public ComponentChooserHelper(Class<JComponent> componentClass,String name){
		this.name = name;
